    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="text-right">
                <a class="btn btn-primary btn-style" href="{{url('/school/create')}}">
                    <i class="fas fa-plus-circle add-circle"></i>Cadastrar Escola
                </a>
            </div>
        </div>
    </div>
...
@endsection
@section('script')
<script src="../public/js/school/index.js"></script>
@endsection